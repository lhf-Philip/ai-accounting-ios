// Frozen persisted models from 664458e9c64f460741b1e22841a75853f5e09bde (advance_links).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaAdvanceLinks: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 4, 0) }
    static var models: [any PersistentModel.Type] {
        [Account.self, Category.self, Tag.self, FinancialTransaction.self, Shortcut.self, CategoryMonthlyBudget.self, AdvanceCase.self, AdvanceParticipant.self, AdvanceRepayment.self]
    }
