// Frozen persisted models from b7e8dda0770400336a3f70ef665e483b6ed7c3aa (recurring).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaRecurring: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 7, 0) }
    static var models: [any PersistentModel.Type] {
        [Account.self, Category.self, Tag.self, FinancialTransaction.self, Shortcut.self, RecurringRule.self, RecurringOccurrence.self, CategoryMonthlyBudget.self, BudgetMonthlyHistory.self, BudgetSettings.self, AdvanceCase.self, AdvanceParticipant.self, AdvanceRepayment.self]
    }
