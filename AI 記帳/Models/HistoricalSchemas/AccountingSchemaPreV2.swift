// Frozen persisted models from abd3b2020d9416a6803f1a1081528c8dbac9defa (pre_v2).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaPreV2: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 8, 0) }
