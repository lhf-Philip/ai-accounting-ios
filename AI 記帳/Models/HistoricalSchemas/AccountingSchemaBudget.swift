// Frozen persisted models from e29c0e44d04751bdae4e47ba5c2206266cdb6cf0 (budget).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaBudget: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 2, 0) }
    static var models: [any PersistentModel.Type] {
        [Account.self, Category.self, Tag.self, FinancialTransaction.self, Shortcut.self, CategoryMonthlyBudget.self]
    }
