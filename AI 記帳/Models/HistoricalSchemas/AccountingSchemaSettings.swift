// Frozen persisted models from f342461ab54a70d502ddf56d4a877f684185e429 (settings).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaSettings: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 6, 0) }
    static var models: [any PersistentModel.Type] {
        [Account.self, Category.self, Tag.self, FinancialTransaction.self, Shortcut.self, CategoryMonthlyBudget.self, BudgetMonthlyHistory.self, BudgetSettings.self, AdvanceCase.self, AdvanceParticipant.self, AdvanceRepayment.self]
    }
