// Frozen persisted models from fb2f437c1b981f46e8b1976df23b456bc7d47468 (history).
// Preserve these definitions. Unchanged enum types are shared with DataModels.swift.
import Foundation
import SwiftData

enum AccountingSchemaHistory: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 5, 0) }
    static var models: [any PersistentModel.Type] {
        [Account.self, Category.self, Tag.self, FinancialTransaction.self, Shortcut.self, CategoryMonthlyBudget.self, BudgetMonthlyHistory.self, AdvanceCase.self, AdvanceParticipant.self, AdvanceRepayment.self]
    }
