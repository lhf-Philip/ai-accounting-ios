// Frozen persisted models from v1.0.1 (9063807944d1b46e2125711338c73acfa20f32e9).
// Preserve these definitions when adding later schema versions. Unchanged enum types are shared.
import Foundation
import SwiftData

enum AccountingSchemaV1: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(1, 0, 1) }
    static var models: [any PersistentModel.Type] { [Account.self, FinancialTransaction.self, Category.self, Tag.self, Shortcut.self] }
