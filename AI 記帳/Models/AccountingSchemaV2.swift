// Frozen persisted models from main before versioning (2b829a5507bced8e1e810a2fd577d27484d25f30).
// Preserve these definitions when adding later schema versions. Unchanged enum types are shared.
import Foundation
import SwiftData
enum AccountingSchemaV2: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(2, 0, 0) }
    static var models: [any PersistentModel.Type] { [Account.self, FinancialTransaction.self, Category.self, Tag.self, Shortcut.self, RecurringRule.self, RecurringOccurrence.self, CategoryMonthlyBudget.self, BudgetMonthlyHistory.self, BudgetSettings.self, AdvanceCase.self, AdvanceParticipant.self, AdvanceRepayment.self] }
